...
class AddCardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val s3 = intent.getStringExtra("stringKey3"); // this string will be current question (edit)
        val s4 = intent.getStringExtra("stringKey4"); // this string will be current answer (edit)
        val s5 = intent.getStringExtra("stringKey5"); // this string will be current question (edit)
        val s6 = intent.getStringExtra("stringKey6"); // this string will be current answer (edit)
